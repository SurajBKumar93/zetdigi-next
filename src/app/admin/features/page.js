...
export default function FeaturesAdmin() {
  ...
  const handleIconUpload = async (e) => {
    ...
    uploadFormData.append('category', 'features');
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex justify-between items-center">
          <p className="text-gray-600">Manage features ({items.length} total)</p>
          <button
            onClick={() => {
              setEditingItem(null);
              setFormData({ title: '', description: '', icon: '' });
        ...
        {items.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No features yet. Add your first one!</p>
          </div>
        )}
      </main>
                ...
                {formData.icon && (
                  <div className="mt-3 flex items-center gap-3">
                    <div className="relative w-20 h-20 bg-gray-100 rounded-lg overflow-hidden">
                      <Image src={formData.icon} alt="Preview" fill className="object-contain p-2" />
                    </div>
                    <button
                      type="button"
