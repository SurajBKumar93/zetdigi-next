    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 flex justify-between items-center">
          <p className="text-gray-600">Manage your portfolio items ({items.length} total)</p>
          <button
            onClick={() => {
              setEditingItem(null);
              setFormData({ name: '', image: '' });
        ...
        {items.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">No portfolio items yet. Add your first one!</p>
          </div>
        )}
      </main>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Ferrari Skates"
                  required
                />
              </div>
